...
const conf = {
    ...
    objectOwnershipProxy_address: '0x6f0DBcFa2568B67F5712C7282e532166D4811e93',
    landObject_class: 1,
...
module.exports = async (deployer, network) => {
    ...
    deployer.deploy(Proxy
        ...
        const proxyAuction = await Proxy.at(clockAuctionProxy_address);
        proxyAuction.upgradeTo(ApostleClockAuction.address);
